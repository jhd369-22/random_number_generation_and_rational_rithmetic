...
TEMPLATE_TEST_CASE("default constructor", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r;
    CHECK(r.numerator() == 0);
    CHECK(r.denominator() == 1);
}

TEMPLATE_TEST_CASE("constructor", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    CHECK(r.numerator() == 1);
    CHECK(r.denominator() == 2);

    ra::math::rational<TestType, TestType> r2(1, -2);
    CHECK(r2.numerator() == -1);
    CHECK(r2.denominator() == 2);

    ra::math::rational<TestType, TestType> r3(3, 6);
    CHECK(r3.numerator() == 1);
    CHECK(r3.denominator() == 2);

    ra::math::rational<TestType, TestType> r4(1, 0);
...
TEMPLATE_TEST_CASE("copy constructor", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    ra::math::rational<TestType, TestType> r2(r);
    CHECK(r2.numerator() == 1);
    CHECK(r2.denominator() == 2);
}
...
TEMPLATE_TEST_CASE("copy assignment operator", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    ra::math::rational<TestType, TestType> r2(6, 9);
    r2 = r;
    CHECK(r2.numerator() == 1);
    CHECK(r2.denominator() == 2);
}
...
TEMPLATE_TEST_CASE("move constructor", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    ra::math::rational<TestType, TestType> r2(std::move(r));
    CHECK(r2.numerator() == 1);
    CHECK(r2.denominator() == 2);
}
...
TEMPLATE_TEST_CASE("is_integer", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    ra::math::rational<TestType, TestType> r2(6, 3);
    CHECK(r.is_integer() == false);
    CHECK(r2.is_integer() == true);
}

TEMPLATE_TEST_CASE("operator!", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(0, 2);
    ra::math::rational<TestType, TestType> r2(6, 9);
    CHECK(!r == true);
    CHECK(!r2 == false);
...
TEMPLATE_TEST_CASE("operator== & operator!=", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    ra::math::rational<TestType, TestType> r2(6, 9);
    ra::math::rational<TestType, TestType> r3(6, 9);
    CHECK(r != r2);
    CHECK((r2 != r3) == false);
    CHECK(r2 == r3);
    CHECK((r == r3) == false);
...
TEMPLATE_TEST_CASE("operator+", "[rational]", int, long, long long) {
    ra::math::rational<TestType, TestType> r(1, 2);
    ra::math::rational<TestType, TestType> r2(6, 9);
    ra::math::rational<TestType, TestType> r3 = r + r2;
...
TEMPLATE_TEST_CASE("operator>>", "[rational]", int, long, long long) {
    ...
    SECTION("incorrect input4") {
        ra::math::rational<TestType, TestType> r;
        std::stringstream ss("a/a");
        REQUIRE(!(ss >> r));
    }

    SECTION("incorrect input5") {
        ra::math::rational<TestType, TestType> r;
        std::stringstream ss("/");
        REQUIRE(!(ss >> r));
    }

    SECTION("incorrect input6") {
        ra::math::rational<TestType, TestType> r;
        std::stringstream ss(" / ");
        REQUIRE(!(ss >> r));
    }
